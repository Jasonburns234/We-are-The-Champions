...
addButtonEl.addEventListener("click", function () {
    ...
    push(ref(database, "endorsementList"), newItem);
...
function appendItemToEndorsementListEl(itemID, item) {
    ...
    newEl.addEventListener("dblclick", function () {
        const exactLocationOfItemInDB = ref(database, `endorsementList/${itemID}`);
...
function updateLikeCount(itemID, likesCount) {
    set(ref(database, `endorsementList/${itemID}/likes`), likesCount);
}
